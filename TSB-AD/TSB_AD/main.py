...
if __name__ == '__main__':
    ...
    # parser.add_argument('--data_direc', type=str, default='TSB-AD/Datasets/TSB-AD-U/')
    parser.add_argument('--data_direc', type=str, default='TSB-AD/Datasets/TSB-AD-M/')
    parser.add_argument('--save', type=bool, default=False)
    parser.add_argument('--AD_Name', type=str, default='HYDRA')
